...
<?php echo form_open('crud/updateSipil8')?>
	<input type="text" id="assessID" name="assessID" value="<?php echo $_GET['id']?>" hidden>
	<input type="text" id="table" name="table" value="assessmentac" hidden>
            ...
            success: function(data){
            	...
            	var json = jQuery.parseJSON(data);
              	$.each(json,function(i,item){
              		$('#select1 option[value='+item.unitindoor+']').attr('selected', 'selected');
              		$('#select2 option[value='+item.unitoutdoor+']').attr('selected', 'selected');
              		$('#select3 option[value='+item.piparefrigerant+']').attr('selected', 'selected');
              		$('#select4 option[value='+item.pipadrainese+']').attr('selected', 'selected');
              		$('#select5 option[value='+item.remotecontrol+']').attr('selected', 'selected');
              		$('#select6 option[value='+item.kinerjasuhuruangan+']').attr('selected', 'selected');
              	});
