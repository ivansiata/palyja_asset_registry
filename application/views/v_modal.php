		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<?php if(isset($_GET['not'])){ echo '<input type="text" id="not" value="'.$_GET["not"].'" hidden >'; } ?>
				</div>
				<div class="modal-body" style="max-height: 460px; overflow: auto">
					...
					<div id="updateLeft" class="col-sm-6" style="padding-left:2%">
						...
						<h4>PO Number : <input type ="text" id="poasset" value="" style="background-color: transparent; border:0px solid; width:19%" readonly><span style="font-size:11px" onclick="openInNewTab1('<?php echo base_url();?>crud/poList?po=')"><a id="linkPO" href="#"></a></span></h4>
						<div id="formDetail" class="form">
		    			 <?php echo form_open_multipart('crud/updateProses')?>
		    			 <input type ="text" id="namaasset2" name="namaasset2" value="" style="background-color: transparent; border:0px solid;" hidden>
							...
							<table style="padding-left:3%;">
								...
								<tr>
									<td style="width:90px">Barcode<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td><input type="text" name="barcode" id="barcode" style="width:210px;" value="" ></td>
								</tr>
								<tr>
									<td>Brand<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td><input type="text" name="brand" id="brand" style="width:210px;" value="" ></td>
								</tr>
								<tr>
									<td>Type<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td><input type="text" name="type" id="type" style="width:210px;" value="" ></td>
								</tr>
								<tr>
									<td>Dimension<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td><input type="text" name="dimension" id="dimension" style="width:210px;" value="" ></td>
								</tr>
								<tr>
									<td>Serial Number<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td><input type="text" name="serial" id="serial" style="width:210px;" value="" ></td>
								</tr>
								<tr>
									 <td>Status<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									 <td>:</td>
					                  <td id="status">
								...
								<tr>
									 <td>Used by<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									 <td>:</td>
								...
								<tr>
									 <td>Purchasing Date<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									 <td>:</td>
					                  <td id="purchDatetd">
								...
								<tr>
									 <td> Install Date<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									 <td>:</td>
					                  <td id="instDatestd">
								...
								<tr>
									<td>Owner<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td><input type="text" name="ownerAs" id="ownerAs" style="width:100px;" value="" disabled></td>
								</tr>
					...
					<div id="formFamily" class="form">
							<table style="padding-left:3%;">
								...
								<tr>
									<td>Subfamily<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td class="chozenSelect">
								...
								<tr>
									<td>Unit<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td class="chozenSelect">
					...
					<div id="formCondition" class="form">
							<table style="padding-left:3%;">
								...
								<tr>
									<td style="width:90px">Date of Survey<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td><input type="date" name="dateofsurvey" id="datepicker" style="width:190px;" value=""></td>
								</tr>
								<tr>
									<td>Surveyor<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
								...
								<tr>    		
									<td>Score 1</td>
									<td>:</td>
									<td><input type="text" name="score1" id="score1" style="width:190px;" value=""></td>
				
								</tr>
								<tr>
									<td>Score 2</td>
									<td>:</td>
									<td><input type="text" name="score2" id="score2" style="width:190px;" value="" ></td>
								</tr>
								<tr>
									<td>Score 3</td>
									<td>:</td>
									<td><input type="text" name="score3" id="score3" style="width:190px;" value="" ></td>
								</tr>
								<tr>
									<td>Score 4</td>
									<td>:</td>
									<td><input type="text" name="score4" id="score4" style="width:190px;" value="" ></td>
								</tr>
								<tr>
									<td>Score 5</td>
									<td>:</td>
									<td><input type="text" name="score5" id="score5" style="width:190px;" value="" ></td>
								</tr>
								<tr>
									<td>Score 6</td>
									<td>:</td>
									<td><input type="text" name="score6" id="score6" style="width:190px;" value="" ></td>
								</tr>
								<tr>
									<td>Overall Condition Score<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
								...
								<tr><td>&nbsp</td></tr>
								<tr>
									<td>Remarks<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
		    		...
		    		<div id="formLocation" class="form" style="width:75%; margin-left:11%">
							<table style="padding-left:3%;">
								...
								<tr>
									<td style="width:90px">Main Location<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td>
								...
								<tr>
									<td>Sub Location<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td>
								...
								<tr>
									<td>Unit Location<?php if(isset($_GET['not'])){echo "<span class='alert' style='color:red; padding:0'>*</span>";} ?></td>
									<td>:</td>
									<td>
					...
					<center><a href="#" id="hrefDisPro"><button type="button" class="btn" style="font-size:12px">Add Disposal Progress</button></a><br><button id="buttonDisposal" type="button" class="btn btn-primary" style="font-size:12px; display:none" hidden>View Disposal Progress</button> </center>
				...
				<div class="modal-footer">
					...
					<?php if(isset($_GET['not'])){ echo '<span style="color:red; padding:0">* required attributes to complete asset details</span>'; } ?>
...
<script type="text/javascript">
	$(function(){
		$('#hrefAsses').on("click", function(){
			$(this).attr("href", $('#baseurl').val()+"crud/assessment?id="+$('#updateID').val())
		})
		$('#hrefAssesRep').on("click", function(){
			$(this).attr("href", $('#baseurl').val()+"crud/assessmentHasilView?id="+$('#updateID').val())
		})

		$('#hrefDisPro').on("click", function(){
			$(this).attr("href", $('#baseurl').val()+"crud/disposalProgress?id="+$('#updateID').val())
		})
		...
		$('#mainlocation').on('change', function(){
	        ...
	        var mainloc = $(this).val().substring(2,4);
	         $.ajax({
	                ...
	                success: function(data){
	                  if(mainloc == 00){
	                    $('#addresslocation').val('')
	                    $('#addresslocation').removeAttr('readonly')
	                  }else{
	                    $('#addresslocation').attr('readonly', 'readonly')
	                    var json = jQuery.parseJSON(data);
	                      $.each(json, function(i, item){
	                        $('#addresslocation').val(item.address);
	                    });
	                  }
			...
			$.ajax({
            type:"POST",
            url: base_url+"crud/get_dataView/"+updateID,
            ...
            success: function(data){
              ...
              $.each(json,function(i,item){
                ...
                $('#instDate').val(item.installdate);
               	...
               	$('#poasset').val(item.no_po)

               	if(item.no_po != null){
               		$('#linkPO').text('View PO Details')
               	}else{
               		$('#linkPO').empty();
               		$('#poasset').val('No PO')
               	}
				...
				if(item.family != "Land & Building"){
					...
					$('#score3').attr('readonly','readonly');
					$('#score4').attr('readonly','readonly');
					$('#score5').attr('readonly','readonly');
					$('#score6').attr('readonly','readonly');
					$('#overallconditionscore').attr('readonly','readonly');
				}
               	
                if($('#session').text().toLowerCase() != item.family.toLowerCase() && $('#session').text().toLowerCase() != "admin" ){
                	$('#inputSave').empty();
                	$('#assessLink').empty();
                	$("#linkReportAssess").empty();
                	$('#hrefAsses').empty();
                }
			...
			$.ajax({
            type:"POST",
            url: base_url+"crud/get_dataSurplusPro/"+updateID,
            data: "updateID="+updateID,
			...
			$('#buttonDisposal').on("click", function(){
              ...
              $.ajax({
		            type:"POST",
		            url: base_url+"crud/countFiles/"+updateID,
		            data: "updateID="+updateID,
		            success: function(data){
	...
	function openInNewTab1(url){
		var win = window.open(url+$('#poasset').val(), '_blank');
    	win.focus();
	}
